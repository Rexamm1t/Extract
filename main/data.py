...
VERSION = "EXTRACT 10.3.0"
VERSION_ALL = "EXTRACT 10.3.0 (4.0.1)"
...
ACHIEVEMENTS = {
    ...
    "slots_master": {
        "name": "Мастер Слотов",
        "description": "Выиграйте в слотах 100 раз",
        "xp_reward": 300
    },
    "trader": {
        "name": "Трейдер",
        "description": "Совершите 50 сделок",
        "xp_reward": 200
    }
}
...
{Fore.WHITE}6. Добавили новые игры: Рулетка, Блэкджек.
{Fore.WHITE}7. Добавили систему достижений.
{Fore.RED}___
        """
