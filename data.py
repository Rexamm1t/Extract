...
VERSION = "EXTRACT 10.1.6"
VERSION_ALL = "EXTRACT 10.1.6 (1.8.25) (UNIX base)"
...
class Casino:
    ...
    def slots(self, bet):
        ...
        if self.current_user.free_spins > 0:
            print(f"{Fore.BLUE}Использован бесплатный спин (осталось: {self.current_user.free_spins-1})")
...
{Fore.WHITE}1. Премиум подписки (eup и eup+) - (BETA!)
{Fore.WHITE}2. Редизайн профиля
{Fore.WHITE}3. Новый арт программы в честь 10 версии
{Fore.WHITE}4. Большое обновление EUM (v2)
{Fore.WHITE}5. Сезонность (Игровые события)
{Fore.WHITE}6. Фикс дюпа с накруткой опыта и наград
{Fore.WHITE}7. Большое количество исправлений
{Fore.WHITE}8. Новые команды
{Fore.WHITE}9. Изменили промт
{Fore.WHITE}10. Переводы
{Fore.WHITE}11. И много чего еще...
{Fore.RED}___\n
        """
